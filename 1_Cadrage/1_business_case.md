...
Cette plateforme SaaS permet aux restaurateurs indépendants de digitaliser rapidement leur présence en ligne et leur menu via QR code. Elle répond à un besoin croissant de simplicité, de visibilité et d’efficacité opérationnelle, avec un MVP léger et rapide à déployer.

## 1. Contexte

Le secteur de la restauration indépendante est en forte transition digitale. De nombreux établissements (restaurants, bars, cafés) ne disposent pas de site web moderne ou utilisent des solutions peu adaptées au mobile.

Par ailleurs, l’usage des QR codes s’est largement démocratisé, mais les solutions existantes sont souvent : 

- Trop complexes
- Trop coûteuses
- Surdimensionnées (caisse, paiement, ERP)

Il existe donc un besoin pour une solution simple, rapide à déployer et adaptée aux petits établissements.
...
- Expérience client non digitale (pas moderne)
- Solutions existantes trop complexes ou coûteuses
- Manque de données sur le comportement client

Ces  limites entraînent une perte d’opportunités commerciales, une dégradation de l’expérience client et une inefficacité opérationnelle.
...
- Permettre la commande sur place sans encaissement
- Gérer simplement leurs tables 
- Accéder à des statistiques d’usage

Le tout dans une solution simple, rapide à configurer (\<30 min) et sans contrainte réglementaire lourde
...
- Exigence de performance et de simplicité
...
Le lancement du projet est par conséquent pertinent et justifié, avec un potentiel d'évolution important (paiement, automatisation, multi-établissements…).

Le projet peut être lancé avec un risque maîtrisé et une forte capacité d’itération.
